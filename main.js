...
console.log(chalk.bold.greenBright(chalk.italic("\t========== Welcome to Azaan ATM ==========")));
console.log(chalk.bold.magentaBright("=".repeat(60)));
while (condition) {
    ...
    if (pinAnswer.pin === myPin) {
        ...
        if (ch1.operation === "Cash Withdrawl") {
            ...
            if (amount.amountWithDraw <= myBalance) {
                ...
                console.log(chalk.bold.white(`Your current balance is ${chalk.bold.yellowBright(myBalance)}`));
            }
            else {
                console.log(chalk.bold.redBright("You don't have sufficient balance in your bank account."));
            }
        }
